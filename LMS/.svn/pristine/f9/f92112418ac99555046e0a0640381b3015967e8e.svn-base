...
<script type="module" src="${pageContext.request.contextPath}/js/app/classroom/professor/prfBoard.js"></script>
</head>
<body>
	<section id="board-root" class="container py-4" data-ctx="${pageContext.request.contextPath}" data-lecture-id="<c:out value='${lectureId}'/>" data-api-base="${pageContext.request.contextPath}/classroom/api/v1/professor/board">
		...
		<div class="d-flex align-items-center justify-content-between mb-3">
			...
			<div class="d-flex align-items-center gap-2">
				...
				</select> <select id="filter-status" class="form-select form-select-sm" style="min-width: 120px;">
		...
		<!-- 타입별 탭 목록(선택 시 유형별 전체 보기) -->
		<section class="mt-4" aria-labelledby="tablist-h">
			<h2 id="tablist-h" class="h5 mb-2">게시글 목록</h2>
			
			<a id="btn-create" class="btn btn-sm btn-primary" href="/classroom/professor/${lectureId}/board/new"> 새 게시글 </a>
