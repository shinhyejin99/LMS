...
.post-header-actions .btn.disabled {
	pointer-events: none;
}
</style>

<script type="module" src="${pageContext.request.contextPath}/js/app/classroom/professor/prfBoardPost.js" defer></script>
</head>
<body>
				...
				<div class="card-body" id="post-body">
					<div class="d-flex align-items-start justify-content-between gap-3 mb-3 flex-wrap" id="post-header">
						...
						<div class="d-flex align-items-start gap-2 post-header-actions">
							<a class="btn btn-outline-secondary btn-sm disabled" aria-disabled="true" id="btn-edit-bottom" href="#">수정</a>
							<a class="btn btn-outline-danger btn-sm disabled" aria-disabled="true" id="btn-delete-bottom" href="#">삭제</a>
						</div>
					</div>
					<hr class="my-3" />
				...
				<div class="card shadow-sm">
					...
					<div class="card-body">
						<form id="reply-form" class="vstack gap-3 mb-4">
							<input type="hidden" id="reply-parent" name="parentReplyId" value="">
							<div id="reply-parent-indicator" class="alert alert-secondary py-2 px-3 d-none">
								<div class="d-flex align-items-center justify-content-between gap-2">
									<span id="reply-parent-label" class="small"></span>
									<button type="button" class="btn btn-outline-secondary btn-sm" id="reply-parent-clear">대댓글 취소</button>
								</div>
							</div>
							<div>
