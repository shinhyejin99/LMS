...
<head>
  ...
  <title>비밀번호 재설정 | JSU LMS</title>
  <meta name="description" content="JSU LMS 비밀번호 재설정"/>
  ...
  <div class="container-xxl">
    <div class="authentication-wrapper authentication-basic container-p-y">
      <div class="authentication-inner">
        <div class="card">
          <div class="card-body">
            <h4 class="mb-2">비밀번호 재설정</h4>
            <p class="mb-8">아이디와 가입 시 등록한 정보로 비밀번호를 재설정할 수 있습니다.</p>
            <!-- 비밀번호 재설정 폼이 들어갈 자리 -->
            <form id="resetPasswordForm" class="mb-3" action="#" method="POST">
              <div class="mb-3">
                <label for="username" class="form-label">아이디</label>
                <input type="text" class="form-control" id="username" name="username" placeholder="아이디를 입력하세요" autofocus required/>
              </div>
              <div class="mb-3">
