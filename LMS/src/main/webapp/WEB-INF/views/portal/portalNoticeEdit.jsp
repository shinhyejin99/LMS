...
<%@ include file="/WEB-INF/views/user/common/userNotificationScript.jspf" %>
    <div class="main-container">
        ...
        <form action="/portal/notice/<c:choose><c:when test="${not empty notice}">modify/${notice.noticeId}</c:when><c:otherwise>register</c:otherwise></c:choose>"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="title" name="title"
                       value="${notice.title}" placeholder="공지사항 제목을 입력하세요" required maxlength="200">
            </div>
...
<%--                        value="${notice.stfDeptName}" placeholder="작성부서명을 입력하세요" required maxlength="50"> --%>
<!--             </div> -->
