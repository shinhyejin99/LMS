...
<head>
<meta charset="UTF-8">
<title>강의 신청 목록</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/lctApplyList.css">
</head>
            ...
            <div class="right-content">
                <div class="search-panel">
                    ...
                    <div class="search-group">
                        ...
                        <div id="statusFilterContainer" class="filter-checkbox-group">
                            <!-- JS로 동적 생성됨 -->
                        </div>
                    </div>
...
<script src="${pageContext.request.contextPath}/js/app/professor/lecture/lctApplyList.js"></script>
